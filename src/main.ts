...
console.log('Товар, выбранный по ID: ', productsModel.getItem("854cef69-976d-4c2a-a18c-2aa45046c390"));
// Cart
...
console.log('Наличие товара в корзине: ', cartModel.checkItem("c101ab44-ed99-4a54-990d-47aa2bb4e7d9"))
console.log('Наличие товара в корзине: ', cartModel.checkItem("412bcf81-7e75-4e70-bdb9-d3c73c9803b7"))
